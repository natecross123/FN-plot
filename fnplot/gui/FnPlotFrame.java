...
public class FnPlotFrame extends javax.swing.JFrame {
    ...
    public FnPlotFrame() {
        ...
        inKeyMap.addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, KeyEvent.CTRL_DOWN_MASK), 
                sendAction);
    }
	...
	ArithProgram program;
        Environment<Double> env = interp.getDefaultState();
    ...
    private void initComponents() {
        ...
        hPanIncrSpinner.setModel(new SpinnerNumberModel(0.5f, null, null, 0.1f));
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(displayPanel, GroupLayout.PREFERRED_SIZE, 532, Short.MAX_VALUE))
        );
