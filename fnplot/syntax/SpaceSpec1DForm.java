 ...
 * @author newts
 */
public abstract class SpaceSpec1DForm extends SpaceSpecForm {
    
    /**
     * Evaluate this expression using the given evaluator for space specifications.
     * @param ssEval An evaluator for space specifications
     * @param env The environment in which to evaluate this expression.
     * @return a 1D point set that represents the points denoted by this form
     * @throws VisitException
     */
    @Override
    public abstract PointSet1D<Double> eval(SpaceSpecEvaluator ssEval, 
