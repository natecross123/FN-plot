...
public interface Visitor<S, T> {
    ...
    // statements
    public T visitStatement(StmtExp exp, S arg) throws VisitException ;
    ...
    public T visitExpIf(ExpIf ifExp, S arg) throws VisitException;
    ...
    public T visitStmtPlot(StmtPlot plotStmt, S arg) throws VisitException;

    public T visitExpLet(ExpLet letExp, S state) throws VisitException;

    public T visitStmtClear(StmtClear clrStmt, S arg) throws VisitException;

    public T visitStmtTabulate(StmtTabulate tabStmt, S arg) throws VisitException;
}
